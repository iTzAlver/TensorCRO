...
def main() -> None:
    ...
    t_cro.fit(fitness_function, directives, max_iter=10, device='/CPU:0', seed=0, shards=None)
    tok = time.perf_counter()
    t_cro.fit(fitness_function, directives, max_iter=10, device='/GPU:0', seed=0, shards=None)
    tak = time.perf_counter()
    t_cro.fit(fitness_function, directives, max_iter=int(1e10), device='/GPU:0', seed=0, shards=None, time_limit=10)
